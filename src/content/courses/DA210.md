...
description: "This courses will introduce students to Python libraries such as NumPy, Pandas, and Matplotlib for data manipulation, analysis, and visualization, enabling them to extract insights from complex datasets through a programmatic approach."
prerequisites:
    - DA110
    - DA111
courseHours: 40
